...
/**
 * S52007 查询金银珠宝行业的所有信息
 *
 * @author wgp
 */
@Service
public class SearchZaDwJyzb extends BaseService {

    private final Logger log = LoggerFactory.getLogger(SearchZaDwJyzb.class);
    ...
    public void execute(AbstractCommonData in, AbstractCommonData inHead, AbstractCommonData out, AbstractCommonData outHead) {
        in.putStringValue("sql", "search_za_dw_jyzbd");
