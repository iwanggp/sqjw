 ...
 */
@Service
public class SearchZaGgcs extends BaseService {

    private final Logger log = LoggerFactory.getLogger(SearchZaGgcs.class);
    ...
    public void execute(AbstractCommonData in, AbstractCommonData inHead, AbstractCommonData out, AbstractCommonData outHead) {
        in.putStringValue("sql", "search_za_dw_ggcs_hy");
