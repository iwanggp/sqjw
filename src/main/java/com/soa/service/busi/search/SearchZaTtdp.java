 ...
 */
@Service
public class SearchZaTtdp extends BaseService {

    private final Logger log = LoggerFactory.getLogger(SearchZaTtdp.class);
    ...
    public void execute(AbstractCommonData in, AbstractCommonData inHead, AbstractCommonData out, AbstractCommonData outHead) {
        ...
        if (lb.equals("tp_all")) {
            in.putStringValue("sql", "search_za_tt_hy");
            ...
            in.putStringValue("sql", "search_za_tt");
