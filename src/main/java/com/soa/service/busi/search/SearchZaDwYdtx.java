 ...
 */
@Service
public class SearchZaDwYdtx extends BaseService {

    private final Logger log = LoggerFactory.getLogger(SearchZaDwYdtx.class);
    ...
    public void execute(AbstractCommonData in, AbstractCommonData inHead, AbstractCommonData out, AbstractCommonData outHead) {
        ...
        if (lb.equals("yd_all")) {
            in.putStringValue("sql", "search_za_dw_ydtx");
            ...
            in.putStringValue("sql", "search_za_dw_ydtx_hy");
