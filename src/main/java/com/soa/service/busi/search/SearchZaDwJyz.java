 ...
 */
@Service
public class SearchZaDwJyz extends BaseService {

    private final Logger log = LoggerFactory.getLogger(SearchZaDwJyz.class);
    ...
    public void execute(AbstractCommonData in, AbstractCommonData inHead, AbstractCommonData out, AbstractCommonData outHead) {
        in.putStringValue("sql", "search_za_dw_jyz");
