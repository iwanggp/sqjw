 ...
 */
@Service
public class SearchZaDwSchool extends BaseService {

    private final Logger log = LoggerFactory.getLogger(SearchZaDwSchool.class);
    ...
    public void execute(AbstractCommonData in, AbstractCommonData inHead, AbstractCommonData out, AbstractCommonData outHead) {
        ...
        if (lb.equals("school_all")) {
            in.putStringValue("sql", "search_za_dw_school");
            ...
            in.putStringValue("sql", "search_za_dw_school_hy");
