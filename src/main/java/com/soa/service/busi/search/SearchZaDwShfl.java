 ...
 */
@Service
public class SearchZaDwShfl extends BaseService {

    private final Logger log = LoggerFactory.getLogger(SearchZaDwShfl.class);
    ...
    public void execute(AbstractCommonData in, AbstractCommonData inHead, AbstractCommonData out, AbstractCommonData outHead) {
        ...
        if (lb.equals("fl_all")) {
            in.putStringValue("sql", "search_za_dw_shfl");
            ...
            in.putStringValue("sql", "search_za_dw_shfl_hy");
