...
public class SearchFw extends BaseService {
    ...
    public void execute(AbstractCommonData in, AbstractCommonData inHead, AbstractCommonData out, AbstractCommonData outHead) {
        ...
        in.putObjectValue("args", new Object[]{in.getStringValue("zgbm1"), in.getStringValue("mph"), in.getStringValue("sh"),in.getStringValue("dyh"),in.getStringValue("fzxm"), in.getStringValue("dz"), in.getStringValue("ks"), in.getStringValue("js")});
