 ...
 */
@Service
public class GetZjh extends BaseService {
    ...
    public void execute(AbstractCommonData in, AbstractCommonData inHead, AbstractCommonData out, AbstractCommonData outHead) {
        in.putStringValue("sql", "get_select_zjh");
        in.putObjectValue("args", new Object[]{in.getStringValue("fzxm"), in.getStringValue("mph"), in.getStringValue("dz")});
